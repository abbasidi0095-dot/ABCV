...
const features = [
  {
    ...
    title: "Parses any job posting",
    desc: "Drop a URL or paste the text. We extract skills, requirements, and keywords automatically.",
  },
  {
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Realistic, role-specific experience written by DeepSeek V4 Flash. Every CV is unique.",
  },
  {
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Modern, Classic, Minimal — each with customizable accent colors and fonts.",
  },
  {
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Photo → base64",
    desc: "Upload any photo. We crop to 3:4, compress under 200KB, and store as base64 — zero file storage needed.",
  },
  {
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Handlebars + Puppeteer renders a pixel-perfect A4 PDF. Download or preview instantly.",
  },
  {
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "AI writes the draft. You tweak the summary, experience, skills, and style before exporting.",
  },
];
      ...
      <section className="relative overflow-hidden px-6 pt-20 pb-28 sm:pt-28 sm:pb-36">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-xs font-medium text-primary backdrop-blur-sm">
            ...
            Powered by DeepSeek V4 Flash via OpenCode Go
          </div>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            {status === "authenticated" ? (
              ...
              <>
                <Button asChild size="lg" className="rounded-full px-8 shadow-lg shadow-primary/20">
                  <Link href="/login">Sign in — it&apos;s free</Link>
                </Button>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-14 max-w-xl text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Three steps to your next CV
            </h2>
          </div>
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              { n: "01", title: "Paste a job", desc: "Paste a URL or the raw posting text. We extract every skill, requirement, and keyword." },
              { n: "02", title: "Add your details", desc: "Name, email, phone, and a photo. We crop, compress, and store it as base64 — no upload drama." },
              { n: "03", title: "Edit & download", desc: "Pick a template, tweak the AI-generated content, and download a pixel-perfect A4 PDF in one click." },
            ].map((s) => (
              <div key={s.n} className="group relative rounded-2xl border border-border/50 bg-white/40 p-6 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-14 max-w-xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              From scraping job postings to rendering production-ready PDFs.
            </p>
          </div>
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <div key={f.title} className="group rounded-2xl border border-border/50 bg-white/40 p-6 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-muted-foreground">
            No account needed to try. When you&apos;re ready, sign in and we&apos;ll save everything.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            {status === "authenticated" ? (
              <Button asChild size="lg" className="rounded-full px-8 shadow-lg shadow-primary/20">
              ...
              <>
                ...
                <Button asChild size="lg" variant="outline" className="rounded-full px-8">
                  <Link href="/new">Try without signing up</Link>
                </Button>
              </>
            )}
          </div>
