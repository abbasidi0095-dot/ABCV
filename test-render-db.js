...
var pdf_1 = require("./src/lib/pdf");
var schemas_1 = require("./src/lib/schemas");
var prisma = new client_1.PrismaClient();
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var user, cv, content, pdf, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.cv.findFirst({ where: { userId: user.id } })];
                case 2:
                    cv = _a.sent();
                    if (!cv)
                        return [2 /*return*/, console.log("No CV")];
                    console.log("Found CV, testing renderCvPdf...");
                    content = void 0;
                    try {
                        content = schemas_1.CVContentSchema.parse(cv.contentJson);
                    }
                    catch (e) {
                        console.warn("Content parse failed, using raw:", e.message);
                        content = cv.contentJson;
                    }
                    return [4 /*yield*/, (0, pdf_1.renderCvPdf)({
                ...
                case 4:
                    e_1 = _a.sent();
                    console.error("Render failed:", e_1);
                    return [3 /*break*/, 7];
